...
namespace Raid_ClanBoss_SpeedTune_Simulator
{
    public partial class Simulation
    {
        ...
        static int champion_1_cooldown;
        static int champion_2_cooldown;
        static int champion_3_cooldown;
        static int champion_4_cooldown;
        static int champion_5_cooldown;
        ...
        public static bool Run_Simulation(string difficulty, float champion_1_speed, float champion_2_speed, float champion_3_speed, float champion_4_speed, float champion_5_speed)
        {
            ...
            champion_1_cooldown = champion_1_cooldown_delay;
            champion_2_cooldown = champion_2_cooldown_delay;
            champion_3_cooldown = champion_3_cooldown_delay;
            champion_4_cooldown = champion_4_cooldown_delay;
            champion_5_cooldown = champion_5_cooldown_delay;
            ...
            while (running)
            {
                ...
                if (clan_boss_turn_meter >= max_turn_meter || champion_1_turn_meter >= max_turn_meter || champion_2_turn_meter >= max_turn_meter || champion_3_turn_meter >= max_turn_meter || champion_4_turn_meter >= max_turn_meter || champion_5_turn_meter >= max_turn_meter)
                {
                    ...
                    else if (clan_boss_turn_meter >= champion_1_turn_meter && clan_boss_turn_meter >= champion_2_turn_meter && clan_boss_turn_meter >= champion_3_turn_meter && clan_boss_turn_meter >= champion_4_turn_meter && clan_boss_turn_meter >= champion_5_turn_meter)
                    {
                        ...
                        if (enable_debuff && (clan_boss_turns_taken - 2) % 3 == 0)
                        {
        ...
        {
            champion_1_unkillable_duration = duration;
            champion_2_unkillable_duration = duration;
            champion_3_unkillable_duration = duration;
            champion_4_unkillable_duration = duration;
            champion_5_unkillable_duration = duration;
        }


        public static void BlockDebuffs(int duration)
        {
            champion_1_block_debuffs_duration = duration;
            champion_2_block_debuffs_duration = duration;
            champion_3_block_debuffs_duration = duration;
            champion_4_block_debuffs_duration = duration;
            champion_5_block_debuffs_duration = duration;
        }


        public static void CounterAttack(int duration)
        {
            champion_1_counter_attack_duration = duration;
            champion_2_counter_attack_duration = duration;
            champion_3_counter_attack_duration = duration;
            champion_4_counter_attack_duration = duration;
            champion_5_counter_attack_duration = duration;
        }


        public static void SpeedBuff(int duration)
        {
            champion_1_increase_speed_duration = duration;
            champion_2_increase_speed_duration = duration;
            champion_3_increase_speed_duration = duration;
            champion_4_increase_speed_duration = duration;
            champion_5_increase_speed_duration = duration;
        }
    }
}